...
from induced_ai_python_sdk.pydantic.task_execute_response_data import TaskExecuteResponseData

class TaskExecuteResponse(BaseModel):
    success: typing.Optional[bool] = Field(None, alias='success')

    data: typing.Optional[TaskExecuteResponseData] = Field(None, alias='data')
