...
class FeedbackSubmissionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["feedback", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["feedback", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        feedback: typing.Union[MetaOapg.properties.feedback, bool, schemas.Unset] = schemas.unset,
