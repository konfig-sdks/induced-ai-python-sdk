...
class ExtractionFromUrlResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ExtractionFromUrlResponseData']:
                return ExtractionFromUrlResponseData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ExtractionFromUrlResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['ExtractionFromUrlResponseData', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['ExtractionFromUrlResponseData', schemas.Unset] = schemas.unset,
